        ...
        for repetition_group in repetition_groups:
            ...
            for rep_ix in range(num_repetitions):
                ...
                repetition_tabs.append(Panel(child=hvo_seq_temp.to_html_plot(filename=repetition_group[rep_ix]),
                                             title=f"Repetition {repetition_group[rep_ix]}"))
...
if __name__ == "__main__":
    ...
    final_tabs = get_repetition_plots(
        root_path,
        filename="PianoRollsAndAudios/SimpleComplex_plots/tested_with_two_participants.html",
        num_participants=2,
        num_repetitions=2)
    ...
    final_tabs = get_repetition_plots(
        root_path,
        filename="PianoRollsAndAudios/SimpleComplex_plots/tested_with_Participant_1_Only.html",
